<template>
  ...
  <div id="sidebar-menu-3" class="sidebar-menu">
    <ul class="nav">
      ...
      <li class="submenu">
        <a href="javascript:void(0);"><img src="/assets/img/product.svg" alt="img"><span>
            Inventory
      ...
      <li class="submenu">
        <a href="javascript:void(0);"><img src="/assets/img/purchase1.svg" alt="img"><span>Sales
      ...
      <li class="submenu">
        <a href="javascript:void(0);"><img src="/assets/img/users1.svg" alt="img"><span>User
      ...
      <li class="submenu">
        <a href="javascript:void(0);"><img src="/assets/img/printer.svg" alt="img"><span>Reports</span>
          <span class="menu-arrow"></span></a>
        <ul>
      ...
      <li class="submenu">
        <a href="javascript:void(0);"><img src="/assets/img/settings.svg" alt="img"><span>
